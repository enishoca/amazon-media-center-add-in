        ...
        if (document.addEventListener && !jQuery.browser.opera) {
            ...
            (function () {
                if (jQuery.isReady) {
                    ...
                    setTimeout(arguments.callee, jQuery126PatchDelay);
                    return;
                } jQuery.ready();
            })();
...
(function (jQuery) {
    ...
    if (jQuery.browser.msie && document.compatMode == "BackCompat") {
        var fixOriginal = jQuery.event.fix;
        jQuery.event.fix = function (event) {
            var e = fixOriginal(event);
            e.pageX -= 2;
            e.pageY -= 2;
            return e;
        };
    ...
    if (!window.goN2Debug) {
        ...
        (function () {
                    ...
                    if (isSafari) {
                        ...
                        if (posDot) {
                            switch (url.substring(posDot + 1, end).toLowerCase()) {
                                case "js": loader = doc.createElement("script");
                                    loader.type = "f";
                                    break;
            ...
            function processUrlList(urlList, target) {
                ...
                return { H: hiPriUrls.length, L: lowPriUrls.length, P: plUrls.length, CL: currentLoaders };
            };
